...
$portugues['missingToken'] = "Não foi fornecido parãmetros para teste";
...
//alnum
$portugues['notAlnum'] = "'%value%' não possui apenas letras e dígitos";

//alpha
$portugues['notAlpha'] = "'%value%' não possui apenas letras";
...
//notempty
$portugues['isEmpty'] = "Preenchimento Obrigatório";
